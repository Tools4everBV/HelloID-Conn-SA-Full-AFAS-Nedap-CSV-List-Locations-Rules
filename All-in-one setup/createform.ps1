...
#Global variable #1 >> NedapOnsCertificatePassword
$tmpName = @'
...
#Global variable #5 >> NedapOnsLocationMappingPath
$tmpName = @'
...
<# Begin: DataSource "Nedap-ons-csv-nedap-location-rules-list" #>
$tmpPsScript = @'
# Set TLS to accept TLS, TLS 1.1 and TLS 1.2
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls -bor [Net.SecurityProtocolType]::Tls11 -bor [Net.SecurityProtocolType]::Tls12
...
Nedap-ons-csv-nedap-location-rules-list
'@ 
Invoke-HelloIDDatasource -DatasourceName $dataSourceGuid_0_Name -DatasourceType "4" -DatasourceInput $tmpInput -DatasourcePsScript $tmpPsScript -DatasourceModel $tmpModel -returnObject ([Ref]$dataSourceGuid_0) 
<# End: DataSource "Nedap-ons-csv-nedap-location-rules-list" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "Nedap - CSV - List Locations Rules" #>
$tmpSchema = @"
[{"key":"locationMappings","templateOptions":{"label":"LocationMappings","required":false,"grid":{"columns":[{"headerName":"AFASOEid","field":"AFASOEid"},{"headerName":"Nedap Location Ids","field":"NedapLocationIds"},{"headerName":"AFASOE","field":"AFASOE"},{"headerName":"Nedap Locations","field":"NedapLocations"}],"height":600,"rowSelection":"single"},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_0","input":{"propertyInputs":[]}},"useFilter":true,"useDefault":false},"type":"grid","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":true}]
"@ 

$dynamicFormGuid = [PSCustomObject]@{} 
$dynamicFormName = @'
Nedap - CSV - List Locations Rules
'@ 
...
'@
$tmpTask = @'
{"name":"Nedap - CSV - List Locations Rules","script":"# your script here","runInCloud":false}
'@ 

Invoke-HelloIDDelegatedForm -DelegatedFormName $delegatedFormName -DynamicFormGuid $dynamicFormGuid -AccessGroups $delegatedFormAccessGroupGuids -Categories $delegatedFormCategoryGuids -UseFaIcon "True" -FaIcon "fa fa-list-alt" -task $tmpTask -returnObject ([Ref]$delegatedFormRef) 
<# End: Delegated Form #>
